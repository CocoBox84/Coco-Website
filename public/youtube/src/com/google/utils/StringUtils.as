package com.google.utils
{
   ...
   public class StringUtils
   {
      ...
      public static function ellipsis(param1:String, param2:TextField, param3:TextFormat = null) : String
      {
         var _loc6_:Number = NaN;
         var _loc7_:Number = NaN;
         var _loc4_:String = param2.text;
         ...
         param2.text = param1;
         if(param2.textWidth > param2.width || param2.textHeight > param2.height)
         {
            _loc7_ = _loc6_ = Math.round(param1.length / 2);
            do
            {
               _loc6_ = Math.floor(_loc6_ / 2);
               param2.text = param1.substring(0,_loc7_) + "...";
               if(param2.textWidth > param2.width || param2.textHeight > param2.height)
               {
                  _loc7_ -= _loc6_;
               }
      ...
      public static function parseRatio(param1:String) : Number
      {
         ...
         var _loc2_:Object = ASPECT_REGEX.exec(param1);
         if(!_loc2_)
         {
            _loc5_ = parseFloat(param1);
            if(isNaN(_loc5_))
            {
               return 0;
            }
         ...
         var _loc3_:Number = parseFloat(_loc2_[1]);
         var _loc4_:Number = parseFloat(_loc2_[2]);
         if(_loc4_ == 0 || isNaN(_loc3_) || isNaN(_loc4_))
         {
            return 0;
         }
      ...
      {
         if(Boolean(param1) && Boolean(trim(param1)))
         {
            return false;
         }
         return true;
      ...
      public static function underscoreSeparatedNumbersToArray(param1:String, param2:int = -1) : Array
      {
         var _loc5_:Number = NaN;
         if(!param1)
         {
         ...
         {
            _loc5_ = parseFloat(_loc3_[_loc4_]);
            if(isNaN(_loc5_))
            {
               return null;
            }
      ...
      public static function formatNumber(param1:Number) : String
      {
         ...
         if(_loc3_[2])
         {
            ...
            return _loc2_.replace(NUMBER_GROUP_RE,"$1,").slice(0,-1);
         }
         return _loc2_;
      }
      ...
      public static function formatTime(param1:Number, param2:Boolean = false, param3:uint = 3, param4:Boolean = false) : String
      {
         ...
         var _loc9_:Number = param4 ? Math.floor(param1 / 3600000) % 24 : Math.floor(param1 / 3600000);
      ...
      {
         var _loc2_:int = int(ALPHANUM_CHAR_ARRAY.length);
         var _loc3_:String = "";
         var _loc4_:uint = 0;
         while(_loc4_ < param1)
         {
            _loc3_ += ALPHANUM_CHAR_ARRAY[int(Math.floor(Math.random() * _loc2_))];
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      public static function addWholeWords(param1:Array, param2:uint, param3:String = "") : String
      {
         ...
         {
            _loc7_ = uint(_loc5_ + _loc6_.length);
      ...
      public static function removeKeyValues(param1:String, param2:String, param3:String) : String
      {
         ...
         while(_loc6_ != -1)
         {
            _loc7_ = int(_loc4_.indexOf("=",_loc6_));
            if(_loc7_ == -1)
            {
            ...
            {
               _loc8_ = int(_loc4_.indexOf(param3,_loc7_));
               if(_loc8_ == -1)
               {
